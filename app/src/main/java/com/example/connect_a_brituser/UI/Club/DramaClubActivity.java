...
public class DramaClubActivity extends AppCompatActivity {
    Button clubRegister;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_drama_club);
        ...
        clubRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DramaClubActivity.this,ClubRegisterActivity.class));
            }
        });
    }
}
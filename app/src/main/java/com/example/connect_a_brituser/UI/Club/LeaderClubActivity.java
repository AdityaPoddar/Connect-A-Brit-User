...
public class LeaderClubActivity extends AppCompatActivity {
    Button clubRegister;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_club);
        ...
        clubRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(LeaderClubActivity.this,ClubRegisterActivity.class));
            }
        });
    }
}